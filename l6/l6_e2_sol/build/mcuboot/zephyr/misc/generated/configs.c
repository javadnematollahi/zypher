...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOOT_PSA_IMG_HASH_ALG_SHA256_DEPENDENCIES, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PM_APP_ALIGNMENT, 0x4000);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PSA_CORE_LITE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PSA_CORE_LITE_HAS_RSA_VERIFY, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PSA_CORE_LITE_HAS_RSA, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PSA_CORE_LITE_HAS_HASH, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PSA_CORE_LITE_HAS_VERIFY_MESSAGE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PSA_CORE_LITE_HAS_VERIFY_HASH, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PSA_CORE_LITE_HAS_VERIFY_SIGNATURE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PSA_CORE_LITE_PUB_KEY_MAX_SIZE, 270);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PSA_CORE_LITE_PRIV_KEY_MAX_SIZE, 0);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PSA_CORE_LITE_AES_KEY_MAX_SIZE, 0);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PSA_CORE_LITE_HAS_VOLATILE_KEY_STORAGE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PSA_CORE_LITE_MAX_VOLATILE_KEYS_COUNT, 1);
