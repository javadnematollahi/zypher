...
MEMORY
    {
    FLASH (rx) : ORIGIN = ((0)), LENGTH = ((65536) - 0x0)
 ...
 *(".kernel.*")
 ...
 usb_cfg_data_area : ALIGN_WITH_INPUT { _usb_cfg_data_list_start = .; KEEP(*(SORT_BY_NAME(._usb_cfg_data.static.*))); _usb_cfg_data_list_end = .;; } > RAM AT > FLASH
    __data_region_end = .;
mcuboot_bs_custom_handlers_area : { _mcuboot_bs_custom_handlers_list_start = .; KEEP(*(SORT_BY_NAME(._mcuboot_bs_custom_handlers.static.*))); _mcuboot_bs_custom_handlers_list_end = .;; } > FLASH
